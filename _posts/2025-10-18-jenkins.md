...
My Vagrantfile for this setup is available [here](https://github.com/rualthan/vagrantfiles/blob/main/jenkins-cluster/Vagrantfile). Review that Vagrantfile. I have added the prerequisites in the agent node as a part of the box initialization.
...
1. Lets add the node
    ...
    1. Credentials: Select jenkins(node1)
    1. Save
1. Create a job
    1. Name: Job1
