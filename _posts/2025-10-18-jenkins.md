...
1. Manage Jenkins > System > Publish over SSH 
    1. SSH Servers > Add
        ...
        1. Scroll and check with "Test Configuration"
        1. Save 

1. Create anew Freestyle job
...
1. Build periodically: Trigger the job as per predefined schedules. It used cron format to define the schedule. Use a cron generator online to create the expression.
